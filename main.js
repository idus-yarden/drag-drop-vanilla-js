...
function rowFactory (id = rowCount, text = "") {
  ...
  const tableRow = elementFactory('tr', {id: id , class: 'row' , ondragstart: "dragStart()" , ondragover: "dragOver()", ondragleave: "saveToStorage()", draggable: true }),
  ...
  input = elementFactory('input', {row_id: id , value: text , class: 'input_text', onchange: "saveToStorage()"}),
  removeButton = elementFactory('button', {class: 'action_delete' , row_id: id, onclick: "removeRow(this)"}, '❌', 'removeButtonSymbol' ),
